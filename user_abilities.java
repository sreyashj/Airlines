...
public interface user_abilities {
	void search_flights(String boarding_location, String destination_location, String departure_date, String return_date) throws IOException;
	...
	void change_booking(String student_id) throws IOException;
}
